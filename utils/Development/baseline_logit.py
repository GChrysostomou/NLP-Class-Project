...
#            nlp = spacy.load('en')
            self.model = LogisticRegression(class_weight = "balanced", penalty = "l1")
            self.freq_vocab = {}
    ...
    def extract_features(self, word, sentence):
        ...
        if self.language == "english":
            ...
            #return[len_chars, number_of_syllables, double_vow, prob_w, curword, double_vow]
            return[len_chars, prob_w, curword]
        else:
            ...
            return [len_chars, prob_w, number_of_syllables]#, double_vow]
