...
#            nlp = spacy.load('en')
            self.model = ExtraTreesClassifier(criterion = "entropy", random_state = 1241241)
            self.freq_vocab = {}
            ...
            self.model = ExtraTreesClassifier(criterion = "entropy", random_state = 124114)
    ...
    def extract_features(self, word, sentence):
        ...
        if self.language == "english":
            ...
            vowel_seq = "0."
            no_vowels = sum([*map(word.lower().count, "aeiouy")])
            consonants = len_chars - no_vowels
            ...
            return[len_chars, number_of_syllables, double_vow, prob_w, curword]
